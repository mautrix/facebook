...
class CommandHandler:
    ...
    def __init__(self, handler: Callable[[CommandEvent], Awaitable[Dict]], needs_auth: bool,
                 needs_admin: bool, management_only: bool, name: str, help_text: str,
                 help_args: str, help_section: HelpSection) -> None:
        """
        Args:
    ...
    def has_permission(self, is_management: bool, is_admin: bool, is_logged_in: bool) -> bool:
...
def command_handler(_func: Optional[Callable[[CommandEvent], Awaitable[Dict]]] = None, *,
    ...
    def decorator(func: Callable[[CommandEvent], Awaitable[Optional[Dict]]]) -> CommandHandler:
        ...
        handler = CommandHandler(func, needs_auth, needs_admin, management_only, actual_name,
                                 help_text, help_args,
                                 help_section)
...
class CommandProcessor:
    ...
    def __init__(self, context: c.Context) -> None:
        self.az, self.config, self.loop = context.core

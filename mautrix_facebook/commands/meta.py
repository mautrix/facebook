...
help_cache = {}  # type: Dict[Tuple[bool, bool, bool], str]


async def _get_help_text(evt: CommandEvent) -> str:
    cache_key = (evt.is_management, evt.sender.is_admin, await evt.sender.is_logged_in())
...
@command_handler(name="help", needs_auth=False,
                 help_section=SECTION_GENERAL,
